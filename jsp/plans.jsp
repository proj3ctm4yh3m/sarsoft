...
<body onunload="GUnload()" class="yui-skin-sam" style="border: 0px; margin: 0px; padding: 0px">
<div id="map_canvas" style="width: 100%; height: 100%"></div>

	<div id="infodiv" style="width: 200px; height: 60px; z-index: 200; position: absolute; top: 30; right: 0; color: #FF9933">
