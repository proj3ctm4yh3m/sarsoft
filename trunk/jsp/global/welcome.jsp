...
<br/>
Create a new search named: <input type="text" size="15" name="newsearch" id="newsearch"/>&nbsp;<button onclick="document.location='/app/setsearch/'+document.getElementById('newsearch').value">Create</button>